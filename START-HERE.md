...
**새 이용 흐름:** 통합 분석에서 직접 종목 추가 또는 포트폴리오에서 계좌 불러오기 → 조사 요청문을 이 채팅에 전달 → AI가 공식 자료 조사·결과 반영 → 통합 분석에서 확인합니다. 별도의 AI API는 사용하지 않습니다. [채팅 조사와 화면 반영 방법](CHAT-RESEARCH.md)을 참고하세요.
